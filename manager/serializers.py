...
class PatientSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Patient
		fields = ('pk', 'name', 'id1', 'severity', 'location','description', 'treatment_plan','location_name', 'bool_connected', 'admission_date', 'machine_assigned', 'machine_assigned_model', 'first_name', 'last_name')
class PatientDetailedSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Patient
		fields = ('pk', 'name', 'id1', 'birth', 'treatment_plan','severity', 'location', 'location_name', 'bool_connected', 'admission_date', 'machine_assigned', 'machine_assigned_model', 'description', 'user_pk', 'role', 'username', 'first_name', 'last_name', 'history_severity_x', 'history_severity_y')
